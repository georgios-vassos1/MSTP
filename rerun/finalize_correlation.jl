...
# FINALIZE the correlation claim: does the LP-proxy-vs-SDDP capacity advantage
# genuinely grow with supply-demand correlation on the SCARCE instance? Full CRN
# sweep rho in {0,0.2,0.4,0.6}, each with a 2nd-OOB robustness check (rep2).
println("=== FINALIZE: CRN capacity-opt correlation sweep (capreg_l20u95, scarce) ===")
for rho in (0.0, 0.2, 0.4, 0.6)
  run_regime("capreg_l20u95", 20.0, rho; check=true)
end
println("DONE")
